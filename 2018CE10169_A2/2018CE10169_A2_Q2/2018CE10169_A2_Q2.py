...
for i in range(len(Elements)):
    N1=Elements[i][0]
    N2=Elements[i][1]
    Elem[i+1]=Beam_element(Nodes[N1],Nodes[N2],E,I)


#Step3: Apply Loads and Restraints(Manual)
Nodes[1].set_Restr([1,0])   #1 for restrained, 0 for unrestrained [Ux_restr,Uy_restr]
Nodes[2].set_Restr([1,0])
Nodes[3].set_Restr([1,0])
Nodes[4].set_Restr([1,1])
Elem[2].set_UDL(7)
