...
# %%
#Defining a Node and Frame element
import numpy as np
...
Nodes[4].set_Restr([1,1,1])
Nodes[2].set_Load([-20,0,0])
Nodes[3].set_Load([0,0,12])
#Assign properties to elements(E,I)
for i in range(len(Elements)):
    N1=Elements[i][0]
    N2=Elements[i][1]
    Elem[i+1]=Frame_element(Nodes[N1],Nodes[N2],E=2.1e8,A=2e-2,I=5e-5)
