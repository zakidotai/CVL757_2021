...
#code her to plot and show the legend also
x = np.arange(0,2*np.pi,0.001)
y=np.sin(x)
z=np.cos(x)
plt.plot(x,y,x,z)
plt.legend(["Sinθ", "Cosθ"], loc ="lower left")
plt.savefig('2021CEZ8290_QNo8')
plt.show()
...
plt.plot(xc,yc,color='red',marker='o',linewidth=2.5,label='DEFORMED',markersize=16)
plt.savefig("2021CEZ8290_QNo9")    
...
#nodes as numbered
#nodes 1,2,3,4,5,6 
coordinates= [(0,0), (5,7), (5,0), (10,7), (10,0), (15,0) ]   
...
dof_seq=[2,3,4,5,6,7,8,9,0,1,10,11]  #ID of dofs are such that the they are divided into unknown dofs and known dofs
                                    #since free_dofs =8, therefore first 8 in dof_seq represent
...
#using fac for increasing small values
fac=30
